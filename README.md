...
The dashboard reads a single 15 MB parquet file at `src/data/county_year_panel_export.parquet`. This is the 44-variable public-release panel constructed from 433.6 million Lightcast (Burning Glass) job postings spanning 2010-2024, covering 3,194 U.S. counties and 47,891 county-year observations.
...
└── src/
    ...
    └── data/
        ├── county_year_panel_export.parquet   # 15 MB, 47,891 x 64
